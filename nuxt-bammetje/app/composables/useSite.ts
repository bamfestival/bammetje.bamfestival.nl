      ...
      visuals: [
        {
          ...
          description: '',
          hideCaption: true,
          imageBase: 'bekersysteem',
          imageAlt: 'Uitleg van het bekersysteem tijdens Bammetje'
        },
        {
          title: 'Draag bij aan de BAM! ledwall',
          description: '',
          hideCaption: true,
          imageBase: 'bijdragen-bam-led-wall',
          imageAlt: 'Oproep om bij te dragen aan de BAM ledwall'
        }
      ]
    },
    sponsorsSection: {
