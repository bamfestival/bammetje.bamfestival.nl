      ...
      >
        ...
        <div class="flip-card-content">
          <span class="stage-chip" :class="stageClass[artist.stage]">
            {{ getStageName(artist.stage) }}
          </span>
          <h3>{{ artist.name }}</h3>
          <p class="flip-description">{{ artist.description }}</p>
          <span class="flip-hint">Tik voor bio en socials</span>
        </div>
      </div>
      <div 
        :id="`artist-back-${artist.name.toLowerCase().replace(/\s+/g, '-')}`"
      ...
      >
        ...
        <div class="flip-back-content">
          ...
          <div class="flip-socials">
            <a v-if="artist.instagram" :href="artist.instagram" target="_blank" rel="noreferrer" :aria-label="`Volg ${artist.name} op Instagram`" class="flip-social-link">
            ...
            <a v-if="artist.youtube" :href="artist.youtube" target="_blank" rel="noreferrer" :aria-label="`Bekijk ${artist.name} op YouTube`" class="flip-social-link">
            ...
            <a v-if="artist.spotify" :href="artist.spotify" target="_blank" rel="noreferrer" :aria-label="`Luister naar ${artist.name} op Spotify`" class="flip-social-link">
            ...
            <a v-if="artist.facebook" :href="artist.facebook" target="_blank" rel="noreferrer" :aria-label="`Volg ${artist.name} op Facebook`" class="flip-social-link">
            ...
            <a v-if="artist.website" :href="artist.website" target="_blank" rel="noreferrer" :aria-label="`Bezoek de website van ${artist.name}`" class="flip-social-link">
